  ...
  function navigationt1() {
    if (appointDr.length > 0) {
      if (appointDr[0].availability[0].t1 == true) {
        ...
        alert(
          "Doctor is not available at this time slot please choose another"
        );
      }
    }
  }
        ...
        <div>
          ...
          <div id="drCard">
            ...
            <div id="text">
              ...
              <div id="button">
                <button
                  className={isTrue1 ? "green-button" : "red-button"}
                  onClick={navigationt1}
                >
                  09AM-12PM
                </button>
                <button
                  className={isTrue2 ? "green-button" : "red-button"}
                  onClick={navigationt2}
                >
                  12PM-03PM
                </button>
                <button
                  className={isTrue3 ? "green-button" : "red-button"}
                  onClick={navigationt3}
                >
                  03PM-06PM
                </button>
                <button
                  className={isTrue4 ? "green-button" : "red-button"}
                  onClick={navigationt4}
                >
                  06PM-09PM
                </button>
              </div>
